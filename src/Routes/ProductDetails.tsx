...
const ProductDetails = () => {
  ...
  const aromas: arm[] = [
    { id: 0, property: "Bisküvi" },
    { id: 1, property: "Çikolata" },
    { id: 2, property: "Muz" },
    { id: 3, property: "Salted Caramel" },
    { id: 4, property: "Choco Nut" },
    { id: 5, property: "Raspberry Cheesecake" },
    { id: 6, property: "Hindistan Cevizi" },
    { id: 7, property: "Çilek" },
  ];
  interface clr {
    id: number;
